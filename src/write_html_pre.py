        ...
        <div class="container">
          ...
          <form>
            <div class="mb-3">
              ...
              <div id="searchHelp" class="form-text">Enter text in Unicode Arabic or <a href="https://en.wikipedia.org/wiki/Buckwalter_transliteration#Buckwalter_transliteration_table">Buckwalter transliteration</a> format, e.g., ءتي or 'ty.</div>
            </div>
